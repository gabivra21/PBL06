...
public class Main {
    public static void main(String[] args) {
        ...
        Passageiro passageiro1 = new Passageiro("Edna", "edna.moda@gmail.com", "trovaoazul", 998760909, motorista1.avaliar() );
        Motorista motorista1 = new Motorista("Claudia", "Cnh Ear", passageiro1.avaliar(), "claudinha@gmail.com", "solamarelo", "Curitiba", "viagens", 992341569);
        Passageiro passageiro2 = new Passageiro("Eduardo", "edu.ardo@gmail.com", "9876alho", 999876523, motorista1.avaliar());
        usuarios.add(passageiro1);
        usuarios.add(passageiro2);
        //Motorista motorista1 = new Motorista("Claudia", "Cnh Ear", passageiro1.avaliar(), "claudinha@gmail.com", "solamarelo", "Curitiba", "viagens", 992341569);
        Motorista motorista2 = new Motorista("Kecio", "Cnh Ear", passageiro1.avaliar(), "kecio.silva@hotmail.com", "yolanda78", "Maringá", "viagens e entregas", 976543267);

        usuarios.add(motorista1);
        usuarios.add(motorista2);
        ...
        passageiro1.avaliar();
        motorista1.avaliar();
        System.out.println(motorista1.avaliacao);
        System.out.println(motorista2.avaliacao);
        System.out.println(passageiro1.avaliacao);
        System.out.println(passageiro2.avaliacao);
        ...
        while (isRunnig) {
            ...
            if (numero == 1) {
                ...
                if (numero2 == 1) {
                    menu.imprimirInfoP1(passageiro1);
                } else {
                    menu.imprimirInfoP2(passageiro2);
                }
            ...
            if (numero == 2) {
                ...
                if (numero3 == 1) {
                    menu.imprimirInfoM1(motorista1);
                } else {
                    menu.imprimirInfoM2(motorista2);
                }
            }
